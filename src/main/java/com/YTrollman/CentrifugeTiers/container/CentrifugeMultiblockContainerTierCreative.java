...
public class CentrifugeMultiblockContainerTierCreative extends Container {
    ...
    protected final CentrifugeControllerTileEntityTierCreative centrifugeTileEntity;
    ...
    public CentrifugeMultiblockContainerTierCreative(int id, World world, BlockPos pos, PlayerInventory inv) {
        this(ModContainers.CENTRIFUGE_MULTIBLOCK_CONTAINER_TIER_CREATIVE.get(), id, world, pos, inv, new IntArray(9));
    }
    ...
    public CentrifugeMultiblockContainerTierCreative(ContainerType<?> containerType, int id, World world, BlockPos pos, PlayerInventory inv, IntArray times) {
        ...
        this.inv = inv;
        this.times = times;
        centrifugeTileEntity = (CentrifugeControllerTileEntityTierCreative) world.getBlockEntity(pos);
    ...
    public CentrifugeControllerTileEntityTierCreative getCentrifugeTileEntity() { return centrifugeTileEntity; }
