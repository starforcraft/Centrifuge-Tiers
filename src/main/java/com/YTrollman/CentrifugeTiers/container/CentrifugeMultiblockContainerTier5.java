...
public class CentrifugeMultiblockContainerTier5 extends Container {
    ...
    public CentrifugeMultiblockContainerTier5(int id, World world, BlockPos pos, PlayerInventory inv) {
        this(ModContainers.CENTRIFUGE_MULTIBLOCK_CONTAINER_TIER_5.get(), id, world, pos, inv, new IntArray(8));
    }
    ...
    public CentrifugeMultiblockContainerTier5(ContainerType<?> containerType, int id, World world, BlockPos pos, PlayerInventory inv, IntArray times) {
        ...
        this.inv = inv;
        this.times = times;
        centrifugeTileEntity = (CentrifugeControllerTileEntityTier5) world.getBlockEntity(pos);
    ...
    public CentrifugeControllerTileEntityTier5 getCentrifugeTileEntity() { return centrifugeTileEntity; }
