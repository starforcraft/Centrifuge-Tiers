...
public class CentrifugeCasingTileEntityTier5 extends TileEntity {
    private BlockPos controllerPos;

    public CentrifugeCasingTileEntityTier5() {
        super(RegistryHandler.CENTRIFUGE_CASING_ENTITY_TIER_5.get());
    }
    ...
    public <T> LazyOptional<T> getCapability(@Nonnull Capability<T> cap, @Nullable Direction side) {
        if (controllerPos !=null) {
            if (this.world !=null) {
            	CentrifugeControllerTileEntityTier5 controllerTE = (CentrifugeControllerTileEntityTier5) this.world.getTileEntity(controllerPos);
