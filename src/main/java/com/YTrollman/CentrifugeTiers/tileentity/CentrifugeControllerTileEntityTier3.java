...
public class CentrifugeControllerTileEntityTier3 extends CentrifugeControllerTileEntity {
    ...
    private final IntArray times = new IntArray(6) {
        public int get(int index) {
            switch(index) {
                ...
                case 3:
                    return CentrifugeControllerTileEntityTier3.this.time[3];
                case 4:
                    return CentrifugeControllerTileEntityTier3.this.time[4];
                case 5:
                    return CentrifugeControllerTileEntityTier3.this.time[5];
                default:
                    return 0;
            }
        }
        ...
        public void set(int index, int value) {
            switch(index) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    CentrifugeControllerTileEntityTier3.this.time[3] = value;
                    break;
                case 4:
                    CentrifugeControllerTileEntityTier3.this.time[4] = value;
                    break;
                case 5:
                    CentrifugeControllerTileEntityTier3.this.time[5] = value;
            }
    ...
    protected void processRecipe(int i) {
        if (canProcess(i)) {
            energyStorage.consumeEnergy(Config.RF_TICK_CENTRIFUGE.get() * 2);
            ++time[i];
    ...
    @Override
    public int getRecipeTime(int i) { return getRecipe(i) != null ? Math.max(5, (int)(getRecipe(i).multiblockTime * 0.333)) : Config.GLOBAL_CENTRIFUGE_RECIPE_TIME.get(); }

    @Override
    protected CustomEnergyStorage createEnergy() {
        return new CustomEnergyStorage(Config.MAX_CENTRIFUGE_RF.get() * 20, 2000, 0) {
            @Override
