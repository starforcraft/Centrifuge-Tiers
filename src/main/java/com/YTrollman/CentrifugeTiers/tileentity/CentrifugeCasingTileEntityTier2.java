...
public class CentrifugeCasingTileEntityTier2 extends TileEntity {
    private BlockPos controllerPos;

    public CentrifugeCasingTileEntityTier2() {
        super(RegistryHandler.CENTRIFUGE_CASING_ENTITY_TIER_2.get());
    }
    ...
    public <T> LazyOptional<T> getCapability(@Nonnull Capability<T> cap, @Nullable Direction side) {
        if (controllerPos !=null) {
            if (this.world !=null) {
            	CentrifugeControllerTileEntityTier2 controllerTE = (CentrifugeControllerTileEntityTier2) this.world.getTileEntity(controllerPos);
