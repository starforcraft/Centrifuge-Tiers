...
public class CentrifugeControllerTileEntityTier2 extends TileEntity implements ITickableTileEntity, INamedContainerProvider {
    ...
    public AutomationSensitiveItemStackHandler h = new CentrifugeControllerTileEntityTier2.TileStackHandler(22);
    ...
    protected final IIntArray times = new IIntArray() {
        public int get(int index) {
            switch(index) {
                case 0:
                    return CentrifugeControllerTileEntityTier2.this.time[0];
                case 1:
                    return CentrifugeControllerTileEntityTier2.this.time[1];
                case 2:
                    return CentrifugeControllerTileEntityTier2.this.time[2];
                default:
                    return 0;
            }
        }
        ...
        public void set(int index, int value) {
            switch(index) {
                case 0:
                	CentrifugeControllerTileEntityTier2.this.time[0] = value;
                    break;
                case 1:
                	CentrifugeControllerTileEntityTier2.this.time[1] = value;
                    break;
                case 2:
                	CentrifugeControllerTileEntityTier2.this.time[2] = value;
            }
    ...
    public CentrifugeControllerTileEntityTier2() {
        super(RegistryHandler.CENTRIFUGE_CONTROLLER_ENTITY_TIER_2.get());
    }
                ...
                if (!h.getStackInSlot(HONEYCOMB_SLOT[i]).isEmpty() && !h.getStackInSlot(BOTTLE_SLOT).isEmpty()) {
                    ...
                    if (this.canProcess(irecipe, i)) {
                        ...
                        if (this.time[i] == this.totalTime) {
                            energyStorage.consumeEnergy(Config.RF_TICK_CENTRIFUGE.get() + 99);
                            this.time[i] = 0;
                            this.totalTime = 80;
    ...
    public Container createMenu(int id, @Nonnull PlayerInventory playerInventory, @Nonnull PlayerEntity playerEntity) {
        ...
        return new CentrifugeMultiblockContainerTier2(id, world, pos, playerInventory, times);
    }

    @Nonnull
    @Override
    public ITextComponent getDisplayName() {
        return new TranslationTextComponent("gui.ctiers.centrifuge_tier_2");
    }
    ...
    public MutableBoundingBox buildStructureBounds() {
        ...
        switch (this.getBlockState().get(CentrifugeControllerBlockTier2.FACING)) {
            case NORTH:
    ...
    public void setCasingsToNotLinked(MutableBoundingBox box){
        BlockPos.getAllInBox(box).forEach((pos -> {
            if (world !=null) {
                ...
                if (block instanceof CentrifugeCasingBlockTier2) {
                    CentrifugeCasingTileEntityTier2 casingTE = (CentrifugeCasingTileEntityTier2) world.getTileEntity(pos);
                    if (casingTE != null) {
    ...
    public boolean validateStructure(World world, @Nullable ServerPlayerEntity player){
        ...
        if (world !=null) {
            if (!validStructure) {
                ...
                world.setBlockState(pos, getBlockState().with(CentrifugeControllerBlockTier2.PROPERTY_VALID, false));
            } else {
                world.setBlockState(pos, getBlockState().with(CentrifugeControllerBlockTier2.PROPERTY_VALID, true));
            }
        }
    ...
    protected class TileStackHandler extends AutomationSensitiveItemStackHandler {
        ...
        @Override
        public AutomationSensitiveItemStackHandler.IAcceptor getAcceptor() {
            return CentrifugeControllerTileEntityTier2.this.getAcceptor();
        }

        @Override
        public AutomationSensitiveItemStackHandler.IRemover getRemover() {
            return CentrifugeControllerTileEntityTier2.this.getRemover();
        }
