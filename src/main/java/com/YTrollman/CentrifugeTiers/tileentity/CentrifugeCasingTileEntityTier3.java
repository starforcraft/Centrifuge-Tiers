...
public class CentrifugeCasingTileEntityTier3 extends TileEntity {
    private BlockPos controllerPos;

    public CentrifugeCasingTileEntityTier3() {
        super(RegistryHandler.CENTRIFUGE_CASING_ENTITY_TIER_3.get());
    }
    ...
    public <T> LazyOptional<T> getCapability(@Nonnull Capability<T> cap, @Nullable Direction side) {
        if (controllerPos !=null) {
            if (this.world !=null) {
            	CentrifugeControllerTileEntityTier3 controllerTE = (CentrifugeControllerTileEntityTier3) this.world.getTileEntity(controllerPos);
