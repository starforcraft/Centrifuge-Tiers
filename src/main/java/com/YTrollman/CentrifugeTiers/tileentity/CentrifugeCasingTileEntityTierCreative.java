...
public class CentrifugeCasingTileEntityTierCreative extends TileEntity {
    private BlockPos controllerPos;

    public CentrifugeCasingTileEntityTierCreative() {
        super(RegistryHandler.CENTRIFUGE_CASING_ENTITY_TIER_CREATIVE.get());
    }
    ...
    public <T> LazyOptional<T> getCapability(@Nonnull Capability<T> cap, @Nullable Direction side) {
        if (controllerPos !=null) {
            if (this.world !=null) {
            	CentrifugeControllerTileEntityTierCreative controllerTE = (CentrifugeControllerTileEntityTierCreative) this.world.getTileEntity(controllerPos);
