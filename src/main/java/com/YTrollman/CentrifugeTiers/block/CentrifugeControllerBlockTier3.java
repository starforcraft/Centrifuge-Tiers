...
public class CentrifugeControllerBlockTier3 extends Block {
    ...
    public ActionResultType onBlockActivated(@Nonnull BlockState state, World world, @Nonnull BlockPos pos, @Nonnull PlayerEntity player, @Nonnull Hand hand, @Nonnull BlockRayTraceResult blockRayTraceResult) {
        if (!world.isRemote) {
            ...
            if (blockEntity != null) {
                if (blockEntity instanceof CentrifugeControllerTileEntityTier3){
                	CentrifugeControllerTileEntityTier3 multiblockCentrifuge =  (CentrifugeControllerTileEntityTier3)blockEntity;
    ...
    public boolean removedByPlayer(BlockState state, World world, BlockPos pos, PlayerEntity player, boolean willHarvest, FluidState fluid) {
        if (!world.isRemote){
        	CentrifugeControllerTileEntityTier3 controller = (CentrifugeControllerTileEntityTier3)world.getTileEntity(pos);
            if (controller !=null){
    ...
    public void onReplaced(@Nonnull BlockState state1, World world, @Nonnull BlockPos pos, @Nonnull BlockState state, boolean isMoving) {
        ...
        if (blockEntity instanceof CentrifugeControllerTileEntityTier3 && state.getBlock() != state1.getBlock()){
        	CentrifugeControllerTileEntityTier3 centrifugeTileEntity = (CentrifugeControllerTileEntityTier3)blockEntity;
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return new CentrifugeControllerTileEntityTier3();
    }
    ...
    public void addInformation(@Nonnull ItemStack stack, @Nullable IBlockReader worldIn, @Nonnull List<ITextComponent> tooltip, @Nonnull ITooltipFlag flagIn) {
        ...
        if (Screen.hasControlDown()){
            tooltip.addAll(new TooltipBuilder()
                    ...
                    .addTip(I18n.format("block.ctiers.centrifuge_tier_3.tooltip.faster"), TextFormatting.AQUA)
                    .addTip(I18n.format("block.ctiers.centrifuge_tier_3.tooltip.multi"), TextFormatting.AQUA)
                    .addTip(I18n.format("block.ctiers.centrifuge_tier_3.tooltip.rfperblock"), TextFormatting.AQUA)
