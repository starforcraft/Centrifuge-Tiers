    ...
    public void appendHoverText(@Nonnull ItemStack stack, @Nullable IBlockReader worldIn, @Nonnull List<ITextComponent> tooltip, @Nonnull ITooltipFlag flagIn) {
        if (Screen.hasShiftDown()){
            tooltip.addAll(new TooltipBuilder()
                    .addTip(I18n.get("block.ctiers.centrifuge_tier_5.tooltip.faster"), TextFormatting.YELLOW)
                    .addTip(I18n.get("block.ctiers.centrifuge_tier_5.tooltip.multi") + number, TextFormatting.YELLOW)
                    .addTip(I18n.get("block.ctiers.centrifuge_tier_5.tooltip.ItemMaxStackSize") + number2, TextFormatting.YELLOW)
