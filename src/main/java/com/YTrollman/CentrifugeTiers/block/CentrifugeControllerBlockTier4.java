    ...
    public void addInformation(@Nonnull ItemStack stack, @Nullable IBlockReader worldIn, @Nonnull List<ITextComponent> tooltip, @Nonnull ITooltipFlag flagIn) {
        if (Screen.hasShiftDown()){
            tooltip.addAll(new TooltipBuilder()
                    .addTip(I18n.format("block.ctiers.centrifuge_tier_4.tooltip.faster"), TextFormatting.YELLOW)
                    .addTip(I18n.format("block.ctiers.centrifuge_tier_4.tooltip.multi") + number, TextFormatting.YELLOW)
                    .addTip(I18n.format("block.ctiers.centrifuge_tier_4.tooltip.ItemMaxStackSize") + number2, TextFormatting.YELLOW)
                    .addTip(I18n.format("block.ctiers.centrifuge_tier_4.tooltip.MaxTankCapacity") + number3, TextFormatting.YELLOW)
                    .addTip(I18n.format("block.ctiers.centrifuge_tier_4.tooltip.rfperblock") + number4 + "x RF", TextFormatting.YELLOW)
                    .build());
        }
        else {
