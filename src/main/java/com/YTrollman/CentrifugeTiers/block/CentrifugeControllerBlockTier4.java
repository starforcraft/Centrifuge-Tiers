    ...
    public void addInformation(@Nonnull ItemStack stack, @Nullable IBlockReader worldIn, @Nonnull List<ITextComponent> tooltip, @Nonnull ITooltipFlag flagIn) {
        if (Screen.hasShiftDown()){
            tooltip.addAll(new TooltipBuilder()
                    ...
                    .addTip(I18n.format("block.ctiers.centrifuge_tier_4.tooltip.multi"), TextFormatting.YELLOW)
                    .addTip(I18n.format("block.ctiers.centrifuge_tier_4.tooltip.ItemMaxStackSize"), TextFormatting.YELLOW)
                    .addTip(I18n.format("block.ctiers.centrifuge_tier_4.tooltip.MaxTankCapacity"), TextFormatting.YELLOW)
                    .addTip(I18n.format("block.ctiers.centrifuge_tier_4.tooltip.rfperblock"), TextFormatting.YELLOW)
                    .build());
        }
        else {
